...
export const updateApiKey = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(user._id, { anthropicApiKey: args.apiKey });
  },
});

export const updateGlobalContext = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.patch(user._id, { globalContext: args.context });
  },
});
